...
class PluginFusioninventoryCronTask extends PluginFusioninventoryItem
{
   ...
   function getTabNameForItem(CommonGLPI $item, $withtemplate = 0) {
      if ($this->canView()) {
         return self::createTabEntry(__('Cron tasks', 'fusioninventory'));
      }
      return '';
   }
   ...
   function showForm($id, $options = []) {
      ...
      echo "<td>";
      Html::autocompletionTextField($this, "command", ['option' => 'size=66']);
      ...
      echo "</td></tr><tr><td>" . __('Storage user') . "</td>";
      echo "<td>";
      Html::autocompletionTextField($this, "user_storage", ['option' => 'size=66']);

      echo "<tr><td>";
      echo "<tr><td>" . __('Minute') . "</td>";
      echo "<td>";
      Html::autocompletionTextField($this, "execution_minute");
      echo "</td></tr>";
      echo "<tr><td>" . __('Hour') . "</td>";
      echo "<td>";
      Html::autocompletionTextField($this, "execution_hour");
      echo "</td></tr>";
      echo "<tr><td>" . __('Day') . "</td>";
      echo "<td>";
      Html::autocompletionTextField($this, "execution_day");
      echo "</td></tr>";
      echo "<tr><td>" . __('Month') . "</td>";
      echo "<td>";
      Html::autocompletionTextField($this, "execution_month");
      echo "</td></tr>";
