 ...
 *@return nothing
 **/
function plugin_fusioninventory_lock_deleteInLockArray($p_itemtype, $p_items_id, $p_fieldToDel) {
	global $DB;

	$fieldsToLock = plugin_fusioninventory_lock_getLockFields($p_itemtype, $p_items_id);
 ...
 *@return nothing
 **/
function plugin_fusioninventory_lock_deleteInAllLockArray($p_itemtype, $p_fieldToDel) {
	global $DB;
   ...
   while ($data=$DB->fetch_array($result)) {
      ...
      plugin_fusioninventory_lock_deleteInLockArray($p_itemtype, $data['items_id'], $p_fieldToDel);
   }
}
 ...
 *@return nothing
 **/
function plugin_fusioninventory_lock_setLockArray($p_itemtype, $p_items_id, $p_fieldsToLock) {
	global $DB;

	$result = plugin_fusioninventory_lock_getLock($p_itemtype, $p_items_id);
 ...
 *@return nothing
 **/
function plugin_fusioninventory_lock_addLocks($p_itemtype, $p_items_id, $p_fieldsToLock) {
	global $DB;
 ...
 **/
function plugin_fusioninventory_lock_getLock($p_itemtype, $p_items_id) {
	global $DB;
 ...
 **/
function plugin_fusioninventory_lock_getLockFields($p_itemtype, $p_items_id) {
	global $DB;

   $db_lock = $DB->fetch_assoc(plugin_fusioninventory_lock_getLock($p_itemtype, $p_items_id));
 ...
 */
function plugin_fusioninventory_exportChecksToArray($p_checksArray) {
   $array = array();
