...
class PluginFusinvinventoryConfig extends CommonDBTM {
   ...
   function initConfigModule() {
      ...
      $input = array();
      $input['import_monitor'] = 0;
      $input['import_printer'] = 0;
      $input['import_peripheral'] = 0;
      $input['import_software'] = 0;
      $input['import_volume'] = 0;
      $input['import_antivirus'] = 0;
      $input['import_registry'] = 0;
      $input['import_process'] = 0;
      $input['component_processor'] = 0;
      $input['component_memory'] = 0;
      $input['component_harddrive'] = 0;
      $input['component_networkcard'] = 0;
      $input['component_graphiccard'] = 0;
      $input['component_soundcard'] = 0;
      $input['component_drive'] = 0;
      $input['component_control'] = 0;
