...
function plugin_fusioninventory_menu() {
...
function plugin_fusioninventory_mini_menu() {
	global $CFG_GLPI,$LANG;
...
function plugin_fusioninventory_mib_management() {
...
function plugin_fusioninventory_Bar ($pourcentage, $message="",$order='') {
