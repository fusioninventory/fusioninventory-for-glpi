<?php
/*
 * @version $Id: rulecollection.class.php 12645 2010-10-07 13:58:51Z yllen $
 -------------------------------------------------------------------------
 FusionInventory
...
class PluginFusioninventoryRuleCollection extends CommonDBTM {
   /// Rule type
   public $sub_type;
   ...
   function showRulesEnginePreviewCriteriasForm($target, $values) {
      ...
      if (count($input)) {
         ...
         foreach ($input as $criteria) {
            ...
            echo "<td>";
            $rule->displayCriteriaSelectPattern($criteria, $criteria, PluginFusioninventoryRule::PATTERN_IS,
