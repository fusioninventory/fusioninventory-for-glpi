<?php
/*
 * @version $Id: ruleaction.class.php 13517 2011-01-05 21:52:27Z yllen $
 -------------------------------------------------------------------------
...
class PluginFusioninventoryRuleAction extends CommonDBChild {
   ...
   **/
   function getRuleActions($ID) {
      ...
      while ($rule = $DB->fetch_assoc($result)) {
         $tmp = new PluginFusioninventoryRuleAction;
         $tmp->fields     = $rule;
         $rules_actions[] = $tmp;
      }
   ...
   **/
   ...
   static function getActions() {
      ...
      return array ('assign'              => $LANG['rulesengine'][22],
                    ...
                    'send'                => $LANG['plugin_fusioninventory']['rules'][8],
                    'add_validation'      => $LANG['plugin_fusioninventory']['rules'][8]);
   }
   ...
   function displayActionSelectPattern($options = array()) {
      ...
      switch ($_POST["action_type"]) {
         ...
         default :
            $actions = PluginFusioninventoryRule::getActionsByType($options["sub_type"]);
