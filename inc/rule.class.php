<?php
/*
 * @version $Id: rule.class.php 12726 2010-10-12 14:22:07Z moyo $
 -------------------------------------------------------------------------
...
//Generic rules engine
   ...
   **/
   function displayCriteriaSelectPattern($name, $ID, $condition, $value="", $test=false) {
      ...
      $display = false;
      if (isset($crit['type'])
          && ($test||$condition==PluginFusioninventoryRule::PATTERN_IS || $condition==PluginFusioninventoryRule::PATTERN_IS_NOT)) {
