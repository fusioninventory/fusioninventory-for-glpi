<?php
/*
 * @version $Id: rule.class.php 13556 2011-01-10 15:23:19Z walid $
 -------------------------------------------------------------------------
 ...
 *   - actions
**/
class PluginFusioninventoryRule extends CommonDBTM {
   ...
   protected $ruleactionclass   = 'PluginFusioninventoryRuleAction';
   protected $rulecriteriaclass = 'PluginFusioninventoryRuleCriteria';
   ...
   **/
   function dropdownRulesMatch($name, $value='', $restrict=false) {
      ...
      if (!$restrict || $restrict == PluginFusioninventoryRule::AND_MATCHING) {
         $elements[PluginFusioninventoryRule::AND_MATCHING] = $LANG['plugin_fusioninventory']['choice'][3];
      }

      if (!$restrict || $restrict == PluginFusioninventoryRule::OR_MATCHING) {
         $elements[PluginFusioninventoryRule::OR_MATCHING]  = $LANG['plugin_fusioninventory']['choice'][2];
      }
   ...
   **/
   function addActionForm($rules_id) {
      ...
      $_POST["field"]    = $val;
      include (GLPI_ROOT."/plugins/fusioninventory/ajax/ruleaction.php");
      echo "</span></td>\n";
   ...
   **/
   function addCriteriaForm($rules_id) {
      ...
      $_POST["sub_type"] = $this->getType();
      $_POST["criteria"] = $val;
      include (GLPI_ROOT."/plugins/fusioninventory/ajax/rulecriteria.php");
      echo "</span></td>\n";
   ...
   **/
   function dropdownCriterias() {
      ...
      ajaxUpdateItemOnSelectEvent("dropdown_criteria$rand", "criteria_span",
                                  $CFG_GLPI["root_doc"]."/plugins/fusioninventory/ajax/rulecriteria.php", $params, false);
   ...
   **/
   function dropdownActions($used=array()) {
      ...
      ajaxUpdateItemOnSelectEvent("dropdown_field$rand", "action_span",
                                  $CFG_GLPI["root_doc"]."/plugins/fusioninventory/ajax/ruleaction.php", $params, false);
   ...
   **/
   function checkCriterias($input) {
      ...
      if ($this->fields["match"]==PluginFusioninventoryRule::AND_MATCHING) {
         $doactions = true;
   ...
   **/
   function checkCriteria(&$criteria, &$input) {
      ...
      if (!is_array($input[$criteria->fields["criteria"]])) {
         ...
         $res = PluginFusioninventoryRuleCriteria::match($criteria, $value, $this->criterias_results,
                                    $partial_regex_result);
      } else {
         //If the value if, in fact, an array of values
         // Negative condition : Need to match all condition (never be)
         if (in_array($criteria->fields["condition"], array(PluginFusioninventoryRule::PATTERN_IS_NOT,
                                                            PluginFusioninventoryRule::PATTERN_NOT_CONTAIN,
                                                            PluginFusioninventoryRule::REGEX_NOT_MATCH,
                                                            PluginFusioninventoryRule::PATTERN_DOES_NOT_EXISTS))) {
            $res = true;
         ...
         foreach ($this->actions as $action) {
            ...
            switch ($action->fields["action_type"]) {
               ...
               case "append_regex_result" :
                  ...
                  $res .= PluginFusioninventoryRuleAction::getRegexResultById($action->fields["value"],
   ...
   **/
   ...
   function getMinimalCriteriaText($fields) {
      ...
      $text .= "<td>" . PluginFusioninventoryRuleCriteria::getConditionByID($fields["condition"], get_class($this))."</td>";
   ...
   **/
   ...
   function getMinimalActionText($fields) {
      ...
      $text .= "<td>" . PluginFusioninventoryRuleAction::getActionByID($fields["action_type"]) . "</td>";
   ...
   **/
   function getCriteriaDisplayPattern($ID, $condition, $pattern) {
      ...
      if ($condition == PluginFusioninventoryRule::PATTERN_EXISTS
          ...
          || $condition == PluginFusioninventoryRule::PATTERN_FIND) {
          return $LANG['plugin_fusioninventory']['choice'][1];

      } else if (($condition==PluginFusioninventoryRule::PATTERN_IS || $condition==PluginFusioninventoryRule::PATTERN_IS_NOT)) {
      ...
      if (isset($action['type'])) {
         ...
         switch ($action['type']) {
            ...
            case "yesno" :
               ...
               return $LANG['plugin_fusioninventory']['choice'][0];
   ...
   **/
   function getCriteriaValue($ID, $condition, $value) {
      ...
      if ($condition!=PluginFusioninventoryRule::PATTERN_IS && $condition!=PluginFusioninventoryRule::PATTERN_IS_NOT) {
         $crit = $this->getCriteria($ID);
         if (isset($crit['type'])) {
   ...
   **/
   function showRulePreviewCriteriasForm($target, $rules_id) {
      ...
      if ($this->getRuleWithCriteriasAndActions($rules_id,1,0)) {
         ...
         $type_match = ($this->fields["match"]==PluginFusioninventoryRule::AND_MATCHING
                        ?$LANG['plugin_fusioninventory']['choice'][3]:$LANG['plugin_fusioninventory']['choice'][2]);
   ...
   **/
   static function dropdown($options=array()) {
      ...
      ajaxDropdown($use_ajax, "/plugins/fusioninventory/ajax/dropdownRules.php", $params, $default, $rand);
   ...
   **/
   ...
   function showNewRuleForm($ID) {
      ...
      $this->dropdownRulesMatch("match", PluginFusioninventoryRule::AND_MATCHING);
