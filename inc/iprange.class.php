...
class PluginFusioninventoryIPRange extends CommonDBTM {
   ...
   static function getTypeName() {
      ...
      if (isset($_SERVER['HTTP_REFERER']) AND strstr($_SERVER['HTTP_REFERER'], 'iprange')) {
         ...
         if ((isset($_POST['glpi_tab'])) AND ($_POST['glpi_tab'] == 1)) {
            ...
            return $LANG['plugin_fusioninventory']['task'][15];
         } else if ((isset($_POST['glpi_tab'])) AND ($_POST['glpi_tab'] == 2)) {
            // Permanent task inventory
            return $LANG['plugin_fusioninventory']['task'][16];
         } else {
   ...
   function defineTabs($options=array()){
      ...
      if ((isset($this->fields['id'])) AND ($this->fields['id'] > 0)){
         $ong[1] = $LANG['plugin_fusioninventory']['profile'][7];
      }
      return $ong;
   }
   ...
   function showForm($id, $options=array()) {
      ...
      echo "<tr class='tab_bg_1'>";
      echo "<td align='center' colspan='2'>" . $LANG['plugin_fusioninventory']['iprange'][0] . 
         "</td>";
      echo "<td align='center' colspan='2'>";
      ...
      echo "<tr class='tab_bg_1'>";
      echo "<td align='center' colspan='2'>" . $LANG['plugin_fusioninventory']['iprange'][1] . 
         "</td>";
      echo "<td align='center' colspan='2'>";
      unset($ipexploded);
      ...
      echo "<input type='text' value='".$ipexploded[0].
         "' name='ip_end0' id='ip_end0' size='3' maxlength='3' onSelect='test(0)'>.";
      echo "<input type='text' value='".$ipexploded[1].
         "' name='ip_end1' id='ip_end1' size='3' maxlength='3' onSelect='test(1)'>.";
      echo "<input type='text' value='".$ipexploded[2].
         "' name='ip_end2' id='ip_end2' size='3' maxlength='3' onSelect='test(2)'>.";
      echo "<input type='text' value='".$ipexploded[3].
         "' name='ip_end3' id='ip_end3' size='3' maxlength='3' onSelect='test(3)'>";
      echo "</td>";
      echo "</tr>";
   ...
   function checkip($a_input) {
      ...
      if ($count == '0') {
         ...
         $message.= $LANG['plugin_fusioninventory']['iprange'][7]."</font><br/>";
         $message.= $LANG['plugin_fusioninventory']['iprange'][0]." : ";
         $message.= $a_input['ip_start0'].".".$a_input['ip_start1'].".";
         $message.= $a_input['ip_start2'].".".$a_input['ip_start3']."<br/>";
         $message.= $LANG['plugin_fusioninventory']['iprange'][1]." : ";
         $message.= $a_input['ip_end0'].".".$a_input['ip_end1'].".";
         $message.= $a_input['ip_end2'].".".$a_input['ip_end3'];
   ...
   function permanentTask($items_id, $module_name, $allowcreate=0) {
      ...
      if ($a_task = $PluginFusioninventoryTask->find("`permanent` LIKE '".$permanent."'", 
                                                     "`id` DESC", "1")) {
         $data = current($a_task);
         $task_id = $data['id'];

         $a_taskjob = $PluginFusioninventoryTaskjob->find("`plugin_fusioninventory_tasks_id`='".
                                                          $task_id."'", "id DESC");
         ...
         if ($allowcreate != "1") {
            ...
            echo "<a href=".getItemTypeFormURL("PluginFusioninventoryIPRange")."id=".$_POST['id'].
               "&allowcreate=1'>".$LANG['plugin_fusioninventory']['task'][18]."</a>";
            echo "</td>";
            echo "</tr>";
            echo "</table>";
            return;
      ...
      echo "<td align='center'>";
      Dropdown::showInteger("periodicity_count", 
                            $PluginFusioninventoryTask->fields['periodicity_count'], 0, 300);
      $a_time = array();
      $a_time[] = "------";
      ...
      $a_time['days'] = "jours";
      $a_time['months'] = "mois";
      Dropdown::showFromArray("periodicity_type", $a_time, 
                              array('value' => 
                                       $PluginFusioninventoryTask->fields['periodicity_type']));
      echo "</td>";
      echo "</tr>";
      ...
      echo "</td>";
      echo "<td>";
      echo $LANG['plugin_fusioninventory']['task'][17]."&nbsp:";
      echo "</td>";
      echo "<td>";
      $com = array();
      $com['push'] = "push";
      ...
      Dropdown::showFromArray("communication", $com, 
                              array('value' => 
                                       $PluginFusioninventoryTask->fields["communication"]));
      echo "</td>";
      echo "</tr>";
