      ...
      $query = "SELECT * FROM `".$this->table."`
		...
		if ($result = $DB->query($query)) {
            ...
            if ($data['discovery_nb_error'] > 0) {
               echo " / <a href='".GLPI_ROOT."/plugins/fusioninventory/front/agentprocess.form.php?process_number=".$data['process_number']."&agent_type=NETDISCOVERY'>
            ...
            if ($data['query_nb_error'] > 0) {
               echo "<a href='".GLPI_ROOT."/plugins/fusioninventory/front/agentprocess.form.php?process_number=".$data['process_number']."&agent_type=SNMPQUERY'>
            ...
            if ($data['query_nb_connections_created'] > 0) {
               echo "<a href='".GLPI_ROOT."/plugins/fusioninventory/front/agentprocess.form.php?process_number=".$data['process_number']."&amp;created=1'>
            ...
            if ($data['query_nb_connections_deleted'] > 0) {
               echo "<a href='".GLPI_ROOT."/plugins/fusioninventory/front/agentprocess.form.php?process_number=".$data['process_number']."&amp;created=0'>
