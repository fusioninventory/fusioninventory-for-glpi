...
define('PHPUnit_MAIN_METHOD', 'Plugins_Fusioninventory_InventorySNMPConnectionslog::main');
 ...
 */
class Plugins_Fusioninventory_InventorySNMPConnectionslog extends PHPUnit_Framework_TestCase {

    public static function main() {
        require_once 'PHPUnit/TextUI/TestRunner.php';

        $suite  = new PHPUnit_Framework_TestSuite('Plugins_Fusioninventory_InventorySNMPConnectionslog');
...
if (PHPUnit_MAIN_METHOD == 'Plugins_Fusioninventory_InventorySNMPConnectionslog::main') {
    Plugins_Fusioninventory_InventorySNMPConnectionslog::main();
