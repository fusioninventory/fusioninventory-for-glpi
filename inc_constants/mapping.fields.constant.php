...
$FUSIONINVENTORY_MAPPING_FIELDS['comment']             = $LANG['common'][25];
...
$FUSIONINVENTORY_MAPPING_FIELDS['manufacturers_id']   = $LANG['common'][5];
$FUSIONINVENTORY_MAPPING_FIELDS['notepad']                = $LANG['title'][37];
$FUSIONINVENTORY_MAPPING_FIELDS['users_id']             = $LANG['common'][34];
$FUSIONINVENTORY_MAPPING_FIELDS['groups_id']            = $LANG['common'][35];
...
$FUSIONINVENTORY_MAPPING_FIELDS['mac']                = $LANG['networking'][15];
$FUSIONINVENTORY_MAPPING_FIELDS['ip']               = $LANG['networking'][14];
$FUSIONINVENTORY_MAPPING_FIELDS['have_serial']         = $LANG['printers'][18]." : ".$LANG['printers'][14];
$FUSIONINVENTORY_MAPPING_FIELDS['have_parallel']            = $LANG['printers'][18]." : ".$LANG['printers'][15];
$FUSIONINVENTORY_MAPPING_FIELDS['have_usb']            = $LANG['printers'][18]." : ".$LANG['printers'][27];
$FUSIONINVENTORY_MAPPING_FIELDS['memory_size']              = $LANG['devices'][6];
...
$FUSIONINVENTORY_MAPPING_FIELDS['networkinterfaces_id']                = $LANG['common'][65];
$FUSIONINVENTORY_MAPPING_FIELDS['netpoints_id']             = $LANG['networking'][51];
...
$FUSIONINVENTORY_MAPPING_FIELDS['suppliers_id']        = $LANG['financial'][26];
