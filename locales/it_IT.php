...
$LANG['plugin_fusioninventory']['menu'][5]="Autentificazione per i materiali distanti (VMware)";
$LANG['plugin_fusioninventory']['menu'][6]="Materiali distanti da inventoriare (VMware)";
...
$LANG['plugin_fusioninventory']['profile'][3]="Controllo remoto dei agenti";
...
$LANG['plugin_fusioninventory']['rules'][7]="Link se possible, se no creazione di materiale";
