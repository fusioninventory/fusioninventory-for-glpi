...
$LANG['plugin_fusinvsnmp']['codetasklog'][5]="modificar del elemento";
...
$LANG['plugin_fusinvsnmp']['legend'][0]="Conexión con un conmutador de red o un servidor en modo trunk o tagged";
...
$LANG['plugin_fusinvsnmp']['mapping'][1423]="Número total de páginas impresas (print)";
$LANG['plugin_fusinvsnmp']['mapping'][1424]="Número de páginas B/N impresas (print)";
$LANG['plugin_fusinvsnmp']['mapping'][1425]="Número de páginas color impresas (print)";
$LANG['plugin_fusinvsnmp']['mapping'][1426]="Número total de páginas impresas (copy)";
$LANG['plugin_fusinvsnmp']['mapping'][1427]="Número de páginas B/N impresas (copy)";
$LANG['plugin_fusinvsnmp']['mapping'][1428]="Número de páginas color impresas (copy)";
...
$LANG['plugin_fusinvsnmp']['mapping'][193]="Kit de Mantenimiento Max";
$LANG['plugin_fusinvsnmp']['mapping'][194]="Kit de Mantenimiento Utilizado";
$LANG['plugin_fusinvsnmp']['mapping'][195]="Kit de Mantenimiento Restante";
...
$LANG['plugin_fusinvsnmp']['mapping'][28]="impresora > métricas > número total de páginas impresas";
$LANG['plugin_fusinvsnmp']['mapping'][29]="impresora > métricas > número de páginas B/N impresas";
$LANG['plugin_fusinvsnmp']['mapping'][2]="red > firmware";
$LANG['plugin_fusinvsnmp']['mapping'][30]="impresora > métricas > número de páginas color impresas";
$LANG['plugin_fusinvsnmp']['mapping'][31]="impresora > métricas > número de páginas monocromo impresas";
...
$LANG['plugin_fusinvsnmp']['mapping'][400]="impresora > consumibles > Kit de mantenimiento (%)";
...
$LANG['plugin_fusinvsnmp']['mapping'][415]="red > número de puertos asociados id del puerto (dot1dBasePortIfIndex)";
...
$LANG['plugin_fusinvsnmp']['mapping'][423]="impresora > métricas > número total de páginas impresas (print)";
$LANG['plugin_fusinvsnmp']['mapping'][424]="impresora > métricas > número de páginas B/N impresas (print)";
$LANG['plugin_fusinvsnmp']['mapping'][425]="impresora > métricas > número de páginas color impresas (print)";
$LANG['plugin_fusinvsnmp']['mapping'][426]="impresora > métricas > número total de páginas impresas (copy)";
$LANG['plugin_fusinvsnmp']['mapping'][427]="impresora > métricas > número de páginas B/N impresas (copy)";
$LANG['plugin_fusinvsnmp']['mapping'][428]="impresora > métricas > número de páginas color impresas (copy)";
$LANG['plugin_fusinvsnmp']['mapping'][429]="impresora > métricas > número total de páginas impresas (fax)";
...
$LANG['plugin_fusinvsnmp']['mapping'][435]="red > sysDescr remoto CDP";
...
$LANG['plugin_fusinvsnmp']['mapping'][438]="red > sysDescr remoto LLDP";
...
$LANG['plugin_fusinvsnmp']['mapping'][54]="impresora > métricas > número de páginas duplex impresas";
$LANG['plugin_fusinvsnmp']['mapping'][55]="impresora > métricas > número of páginas escaneadas";
...
$LANG['plugin_fusinvsnmp']['mapping'][98]="impresora > consumibles > Kit de mantenimiento (max)";
$LANG['plugin_fusinvsnmp']['mapping'][99]="impresora > consumibles > Kit de mantenimiento (remaining)";
...
$LANG['plugin_fusinvsnmp']['processes'][37]="Total de IP's";

$LANG['plugin_fusinvsnmp']['profile'][2]="Configuración";
$LANG['plugin_fusinvsnmp']['profile'][4]="Rango de IP's";
...
$LANG['plugin_fusinvsnmp']['prt_history'][20]="Historal de métricas de impresora";
...
$LANG['plugin_fusinvsnmp']['setup'][20]="Moviendo el historial de creación de conexiones";
