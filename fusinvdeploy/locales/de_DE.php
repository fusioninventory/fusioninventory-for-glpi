...
$LANG['plugin_fusinvdeploy']['check'][6]="SHA512 Prüfsumme";
$LANG['plugin_fusinvdeploy']['check'][7]="Freier Speicherplatz";
...
$LANG['plugin_fusinvdeploy']['deploystatus'][0]="Verteilstatus";
$LANG['plugin_fusinvdeploy']['deploystatus'][1]="Verknüpfte Logs";
$LANG['plugin_fusinvdeploy']['deploystatus'][2]="Der Agent hat Auftragsanforderung erhalten";
...
$LANG['plugin_fusinvdeploy']['files'][6]="Maximale Dateigrösse";
$LANG['plugin_fusinvdeploy']['files'][7]="Upload From";
$LANG['plugin_fusinvdeploy']['files'][8]="Dieser Computer";
$LANG['plugin_fusinvdeploy']['files'][9]="Der Server";
...
$LANG['plugin_fusinvdeploy']['group'][0]="Gruppen von Computern";
$LANG['plugin_fusinvdeploy']['group'][1]="Static group";
$LANG['plugin_fusinvdeploy']['group'][2]="Dynamic group";
$LANG['plugin_fusinvdeploy']['group'][3]="Gruppe von Computern";
$LANG['plugin_fusinvdeploy']['group'][4]="Gruppe hinzufügen";
$LANG['plugin_fusinvdeploy']['group'][5]="If no line in the list is selected, the text fields on the left will be used for search.";

$LANG['plugin_fusinvdeploy']['label'][0]="Typ";
$LANG['plugin_fusinvdeploy']['label'][10]="ID";
$LANG['plugin_fusinvdeploy']['label'][11]="Befehl";
$LANG['plugin_fusinvdeploy']['label'][12]="Disk or directory";
$LANG['plugin_fusinvdeploy']['label'][13]="Schlüssel";
$LANG['plugin_fusinvdeploy']['label'][14]="Schlüsselwert";
$LANG['plugin_fusinvdeploy']['label'][15]="Fehlende Datei";
$LANG['plugin_fusinvdeploy']['label'][16]="Von";
...
$LANG['plugin_fusinvdeploy']['label'][23]="Entpacken Sie die Datei nach dem Download";
$LANG['plugin_fusinvdeploy']['label'][2]="Wert";
$LANG['plugin_fusinvdeploy']['label'][3]="Einheit";
$LANG['plugin_fusinvdeploy']['label'][4]="Aktiv";
$LANG['plugin_fusinvdeploy']['label'][5]="Datei";
$LANG['plugin_fusinvdeploy']['label'][6]="P2P Verteilung";
$LANG['plugin_fusinvdeploy']['label'][7]="Date added";
$LANG['plugin_fusinvdeploy']['label'][8]="Gültigkeitsdatum";
...
$LANG['plugin_fusinvdeploy']['message'][2]="Lädt...";
$LANG['plugin_fusinvdeploy']['message'][3]="File already exist";
$LANG['plugin_fusinvdeploy']['message'][4]="MS Windows-Pfade nicht akzeptieren mehr als 255 Zeichen, der Wert, den Sie eingegeben haben diesen Grenzwert überschreitet.<br /><br /><b>Wollen Sie fortfahren?</b><br /><br /><div class";
$LANG['plugin_fusinvdeploy']['message'][5]="Achtung";
$LANG['plugin_fusinvdeploy']['message'][6]="Möchten Sie den Befehl zur Installation und Deinstallation wird automatisch zu Ihrer Datei hinzugefügt?";
...
$LANG['plugin_fusinvdeploy']['package'][15]="Deinstallation";
$LANG['plugin_fusinvdeploy']['package'][16]="Paketinstallation";
$LANG['plugin_fusinvdeploy']['package'][17]="Paketentfernung";
$LANG['plugin_fusinvdeploy']['package'][18]="Datei verschieben";
$LANG['plugin_fusinvdeploy']['package'][19]="Teile von Dateien";
$LANG['plugin_fusinvdeploy']['package'][1]="Befehl";
$LANG['plugin_fusinvdeploy']['package'][20]="Datei löschen";
$LANG['plugin_fusinvdeploy']['package'][21]="Dialog anzeigen";
...
$LANG['plugin_fusinvdeploy']['package'][25]="Neuer Name";
$LANG['plugin_fusinvdeploy']['package'][26]="Paket hinzufügen";
$LANG['plugin_fusinvdeploy']['package'][27]="Ordner erstellen";
$LANG['plugin_fusinvdeploy']['package'][28]="Datei kopieren";
...
$LANG['plugin_fusinvdeploy']['setup'][17]="Das Plugin FusionInventory DEPLOY benötigt ein aktiviertes FusionInventory Plugin um selber aktiviert zu werden.";
$LANG['plugin_fusinvdeploy']['setup'][18]="Das Plugin FusionInventory DEPLOY benötigt ein aktiviertes FusionInventory Plugin um selber deinstalliert werden zu können.";
...
$LANG['plugin_fusinvdeploy']['task'][16]="Ordner löschen";
...
$LANG['plugin_fusinvdeploy']['task'][1]="Aufgabe";
