...
$LANG['plugin_fusioninventory']['antivirus'][0]="Viirusetõrje";
$LANG['plugin_fusioninventory']['antivirus'][1]="No antivirus on this computer";
$LANG['plugin_fusioninventory']['antivirus'][2]="Versioon";
$LANG['plugin_fusioninventory']['antivirus'][3]="Ajakohane";
...
$LANG['plugin_fusioninventory']['computer'][0]="Viimane laoseis";
...
$LANG['plugin_fusioninventory']['importxml'][3]="XML-fail pole korrektne!";
...
$LANG['plugin_fusioninventory']['menu'][9]="Kriteeriumi reeglid";
$LANG['plugin_fusioninventory']['menu'][10]="Must nimekiri";
$LANG['plugin_fusioninventory']['menu'][11]="Andmete korrasoleku kontroll";
...
$LANG['plugin_fusioninventory']['rule'][21]="Olemasolev kriteerium";
$LANG['plugin_fusioninventory']['rule'][22]="Seerianumber";
$LANG['plugin_fusioninventory']['rule'][30]="Import in asset";
$LANG['plugin_fusioninventory']['rule'][31]="Import in unknown devices";
$LANG['plugin_fusioninventory']['rule'][23]="MAC aadress";
$LANG['plugin_fusioninventory']['rule'][24]="Microsofti tootevõti";
$LANG['plugin_fusioninventory']['rule'][25]="Arvuti mudel";
$LANG['plugin_fusioninventory']['rule'][26]="Kõvaketta seerianumber";
$LANG['plugin_fusioninventory']['rule'][27]="Partitions serial number";
$LANG['plugin_fusioninventory']['rule'][28]="Silt";
...
$LANG['plugin_fusioninventory']['setup'][20]="Importimise valikud";
$LANG['plugin_fusioninventory']['setup'][21]="Komponendid";
$LANG['plugin_fusioninventory']['setup'][22]="Üldine import";
$LANG['plugin_fusioninventory']['setup'][23]="Importi pole";
$LANG['plugin_fusioninventory']['setup'][24]="Ainulaadne import";
$LANG['plugin_fusioninventory']['setup'][25]="Register";
...
$LANG['plugin_fusioninventory']['setup'][36]="Vaikimisi staatus";
