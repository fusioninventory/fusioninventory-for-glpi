...
$LANG['plugin_fusioninventory']['profile'][3] = "Comando à distanza dei agenti";
...
$LANG['plugin_fusioninventory']['errors'][50] = "La versione di GLPI non è compatibile, è necessaria la versione 0.78";
$LANG['plugin_fusioninventory']['errors'][1] = "PHP allow_url_fopen è disattivata, Sveglia del agente impossibile per fare l'inventario";
...
$LANG['plugin_fusioninventory']['rules'][11] = "é gia presente in GLPI";
$LANG['plugin_fusioninventory']['rules'][12] = "é vuoto";
...
$LANG['plugin_fusioninventory']['rulesengine'][152] = "Materiale dà importare";
...
$LANG['plugin_fusioninventory']['codetasklog'][1]="Gettone non corretto, non può agire sull'agente";
