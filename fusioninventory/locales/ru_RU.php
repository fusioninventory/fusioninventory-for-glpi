...
$LANG['plugin_fusioninventory']['agents'][33]="Автоматическое управление динамическими агентами (той же подсети)";
...
$LANG['plugin_fusioninventory']['agents'][41]="URL для агента";
$LANG['plugin_fusioninventory']['agents'][42]="Useragent";
$LANG['plugin_fusioninventory']['agents'][43]="Информация для конфигурации агента";
$LANG['plugin_fusioninventory']['agents'][44]="URL для подключения к серверу";
$LANG['plugin_fusioninventory']['agents'][45]="Исключения";
...
$LANG['plugin_fusioninventory']['codetasklog'][3]="Импорт запрещен";

$LANG['plugin_fusioninventory']['config'][0]="Интервал инвентаризации (в часах)";
...
$LANG['plugin_fusioninventory']['credential'][4]="Учетные данные";
...
$LANG['plugin_fusioninventory']['iprange'][0]="Начало IP диапазона";
$LANG['plugin_fusioninventory']['iprange'][1]="Конец IP диапазона";
$LANG['plugin_fusioninventory']['iprange'][2]="Диапазон IP адресов";
$LANG['plugin_fusioninventory']['iprange'][3]="Запрос";
$LANG['plugin_fusioninventory']['iprange'][7]="Неверный IP";

$LANG['plugin_fusioninventory']['locks'][0]="Удалить блокировки";
$LANG['plugin_fusioninventory']['locks'][1]="Добавить блокировки";

$LANG['plugin_fusioninventory']['menu'][1]="Управление агентами";
$LANG['plugin_fusioninventory']['menu'][2]="Конфигурация диапазонов IP адресов";
$LANG['plugin_fusioninventory']['menu'][3]="Меню";
$LANG['plugin_fusioninventory']['menu'][4]="Неизвестное устройство";
$LANG['plugin_fusioninventory']['menu'][5]="Аутентификация для удаленных устройств (VMware)";
$LANG['plugin_fusioninventory']['menu'][6]="Удаленные устройства для инвентаризации (VMware)";
...
$LANG['plugin_fusioninventory']['rules'][21]="Информация об импорте";
...
$LANG['plugin_fusioninventory']['rules'][7]="Ссылка если возможно, иначе создать устройство";
...
$LANG['plugin_fusioninventory']['task'][15]="Новое действие";
$LANG['plugin_fusioninventory']['task'][17]="Частота";
$LANG['plugin_fusioninventory']['task'][18]="Задачи";
$LANG['plugin_fusioninventory']['task'][19]="Запущенные задачи";
$LANG['plugin_fusioninventory']['task'][1]="Менеджмент Задач";
$LANG['plugin_fusioninventory']['task'][20]="Законченные задачи";
...
$LANG['plugin_fusioninventory']['task'][40]="Принудительный старт";
...
$LANG['plugin_fusioninventory']['task'][46]="Реинициализация";
$LANG['plugin_fusioninventory']['task'][47]="Уникальный id";
$LANG['plugin_fusioninventory']['task'][48]="В Inventory";
$LANG['plugin_fusioninventory']['task'][49]="Расширенный режим";
$LANG['plugin_fusioninventory']['task'][50]="Завершить задачу";
$LANG['plugin_fusioninventory']['task'][51]="Действие после завершения запущенной задачи";
$LANG['plugin_fusioninventory']['task'][52]="Удалить эту задачу и закончить";
...
$LANG['plugin_fusioninventory']['wizard'][0]="Выбор действия";
$LANG['plugin_fusioninventory']['wizard'][10]="Выбор (сетевое обнаружение или inventory)";
$LANG['plugin_fusioninventory']['wizard'][11]="Навигация";
$LANG['plugin_fusioninventory']['wizard'][12]="Обнаружение в сети";
$LANG['plugin_fusioninventory']['wizard'][13]="Инвентаризируемые устройства";
$LANG['plugin_fusioninventory']['wizard'][14]="Добро пожаловать в FusionInventory. Приступить к настройкам?";
...
$LANG['plugin_fusioninventory']['wizard'][18]="Помощник";
...
$LANG['plugin_fusioninventory']['wizard'][4]="Конфигурация агента";
$LANG['plugin_fusioninventory']['wizard'][5]="Управление аутентификацией";
$LANG['plugin_fusioninventory']['wizard'][6]="Управление ESX серверами";
$LANG['plugin_fusioninventory']['wizard'][7]="Запустить задачи";
