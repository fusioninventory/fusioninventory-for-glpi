...
if(isset($_POST["glpi_tab"])) {
   if (strpos($_POST["glpi_tab"], 'PluginFusioninventoryDeployInstall') !== false) {
      $render = "install";
      $title2 = __('before installation','fusioninventory');

   } elseif (strpos($_POST["glpi_tab"], 'PluginFusioninventoryDeployUninstall') !== false) {
      $render = "uninstall";
      $title2 = __('before uninstallation','fusioninventory');
...
$JS = sprintf(
    $JS,
    __('Register key exists', 'fusioninventory'),
    __('Register key missing', 'fusioninventory'),
    __('Register key value', 'fusioninventory'),
    __('File exists', 'fusioninventory'),
    __('File missing', 'fusioninventory'),
    __('File size greater than', 'fusioninventory'),
    __('File size equals to', 'fusioninventory'),
    __('File size lower than', 'fusioninventory'),
    __('SHA512 hash value', 'fusioninventory'),
    __('Free space', 'fusioninventory')
    );
...
$JS = sprintf(
    $JS,
    __('Add a check', 'fusioninventory'),
    __('Add a check', 'fusioninventory'),
    __('Delete a check', 'fusioninventory')
);

$JS.= <<<JS
check_grid_rowSelectionModel = new Ext.grid.RowSelectionModel({
      singleSelect: true,
      listeners: {
...
var {$render}checkGrid = new Ext.grid.GridPanel({
   ...
   tbar: grid_check_tbar,
   sm: check_grid_rowSelectionModel,
   enableDragDrop: true,
   plugins: check_grid_plugins
