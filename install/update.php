...
//   $pfIgnoredimportdevice->install();
   ...
   if (!TableExists('glpi_plugin_fusioninventory_inventorycomputeroracledbs')) {
      $query = "CREATE TABLE IF NOT EXISTS `glpi_plugin_fusioninventory_inventorycomputeroracledbs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `entities_id` int(11) NOT NULL DEFAULT '0',
  `computers_id` int(11) NOT NULL DEFAULT '0',
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  ...
  `has_provisionning_patch_automation_pack_for_database` tinyint(1) NOT NULL DEFAULT '0',
