...
RENAME TABLE `glpi_plugin_fusioninventory_construct_walks` TO `glpi_plugin_fusinvsnmp_constructdevicewalks`;
RENAME TABLE `glpi_plugin_fusioninventory_rangeip` TO `glpi_plugin_fusinvsnmp_ipranges`;
...
ALTER TABLE `glpi_plugin_fusinvsnmp_constructdevicewalks`
   CHANGE `ID` `id` INT( 11 ) NOT NULL AUTO_INCREMENT,
   CHANGE `construct_device_id` `plugin_fusinvsnmp_constructdevices_id` INT( 11 ) NOT NULL DEFAULT '0';

ALTER TABLE `glpi_plugin_fusinvsnmp_ipranges`
   CHANGE `ID` `id` INT( 11 ) NOT NULL AUTO_INCREMENT,
