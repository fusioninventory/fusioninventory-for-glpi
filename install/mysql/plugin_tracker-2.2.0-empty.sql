...
DROP TABLE IF EXISTS `glpi_plugin_tracker_config_modules`;
...
CREATE TABLE IF NOT EXISTS `glpi_plugin_tracker_profiles` (
  ...
  `tracker_task` char(1) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `glpi_plugin_tracker_rangeip` (
  `ID` int(8) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `FK_tracker_agents_discover` int(11) NOT NULL DEFAULT '0',
  `FK_tracker_agents_query` INT( 11 ) NOT NULL DEFAULT '0',
