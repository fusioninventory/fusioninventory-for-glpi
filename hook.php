...
function plugin_headings_fusioninventory_locks($item) {
   ...
   if ($id == '') {
      $fusioninventory_locks->showForm(getItemTypeFormURL::deleteDir('PluginFusioninventoryLock'),
                                                       $type);
   } else {
      $fusioninventory_locks->showForm(getItemTypeFormURL::deleteDir('PluginFusioninventoryLock').'?id='.$id,
                                                       $type, $id);
   }
}
