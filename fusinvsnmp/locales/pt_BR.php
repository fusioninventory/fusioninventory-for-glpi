...
$LANG['plugin_fusinvsnmp']['errors'][50]="GLPI versão não compatível, exigem 0.78";
...
$LANG['plugin_fusinvsnmp']['mapping'][13]="rede > número de série";
...
$LANG['plugin_fusinvsnmp']['mapping'][19]="rede > VLAN";
$LANG['plugin_fusinvsnmp']['mapping'][1]="rede > locação";
$LANG['plugin_fusinvsnmp']['mapping'][20]="rede > nome";
$LANG['plugin_fusinvsnmp']['mapping'][21]="rede > memória total";
...
$LANG['plugin_fusinvsnmp']['mapping'][2]="rede > firmware";
...
$LANG['plugin_fusinvsnmp']['mib'][4]="adicionar um OID ...";
...
$LANG['plugin_fusinvsnmp']['model_info'][10]="Importação do modelo SNMP";
...
$LANG['plugin_fusinvsnmp']['model_info'][15]="Importação em massa de modelos";
$LANG['plugin_fusinvsnmp']['model_info'][16]="Mass import of models in folder plugins/fusinvsnmp/models/";
$LANG['plugin_fusinvsnmp']['model_info'][2]="Versão SNMP";
$LANG['plugin_fusinvsnmp']['model_info'][3]="Autenticação SNMP";
$LANG['plugin_fusinvsnmp']['model_info'][4]="SNMP models";
$LANG['plugin_fusinvsnmp']['model_info'][6]="Editar modelo SNMP";
$LANG['plugin_fusinvsnmp']['model_info'][7]="Criar modelo SNMP";
$LANG['plugin_fusinvsnmp']['model_info'][9]="Importação foi concluído com êxito";
...
$LANG['plugin_fusinvsnmp']['profile'][2]="Configuração";
$LANG['plugin_fusinvsnmp']['profile'][4]="Faixa de IP";
$LANG['plugin_fusinvsnmp']['profile'][5]="Equipamentos de rede SNMP";
$LANG['plugin_fusinvsnmp']['profile'][6]="Impressora SNMP";
$LANG['plugin_fusinvsnmp']['profile'][7]="Modelo SNMP";
$LANG['plugin_fusinvsnmp']['profile'][8]="Impressoras relatório";
$LANG['plugin_fusinvsnmp']['profile'][9]="Redes relatório";

$LANG['plugin_fusinvsnmp']['prt_history'][0]="História e estatísticas de contadores de impressora";
$LANG['plugin_fusinvsnmp']['prt_history'][12]="Total de páginas impressas";
$LANG['plugin_fusinvsnmp']['prt_history'][13]="Páginas / dia";
$LANG['plugin_fusinvsnmp']['prt_history'][20]="History meter printer";
$LANG['plugin_fusinvsnmp']['prt_history'][21]="Data";
$LANG['plugin_fusinvsnmp']['prt_history'][22]="Metro";
$LANG['plugin_fusinvsnmp']['prt_history'][31]="Unidade de tempo";
$LANG['plugin_fusinvsnmp']['prt_history'][32]="Adicionar uma impressora";
$LANG['plugin_fusinvsnmp']['prt_history'][33]="Remover uma impressora";
$LANG['plugin_fusinvsnmp']['prt_history'][34]="dia";
$LANG['plugin_fusinvsnmp']['prt_history'][35]="semana";
$LANG['plugin_fusinvsnmp']['prt_history'][36]="mês";
$LANG['plugin_fusinvsnmp']['prt_history'][37]="ano";
$LANG['plugin_fusinvsnmp']['prt_history'][38]="Impressoras para comparar";
...
$LANG['plugin_fusinvsnmp']['snmp'][13]="Uso de CPU (em%)";
$LANG['plugin_fusinvsnmp']['snmp'][14]="Uso de memória (em%)";
$LANG['plugin_fusinvsnmp']['snmp'][40]="Ports array";
$LANG['plugin_fusinvsnmp']['snmp'][41]="Descrição porta";
$LANG['plugin_fusinvsnmp']['snmp'][46]="Número de bytes recebidos";
$LANG['plugin_fusinvsnmp']['snmp'][48]="Número de bytes enviados";
$LANG['plugin_fusinvsnmp']['snmp'][49]="Número de erros na recepção";
$LANG['plugin_fusinvsnmp']['snmp'][4]="Sysdescr";
$LANG['plugin_fusinvsnmp']['snmp'][51]="Duplex";
$LANG['plugin_fusinvsnmp']['snmp'][53]="Último inventário";
$LANG['plugin_fusinvsnmp']['snmp'][54]="Datas não disponíveis";
$LANG['plugin_fusinvsnmp']['snmp'][55]="Number per second";

$LANG['plugin_fusinvsnmp']['snmpauth'][1]="Comunidade";
$LANG['plugin_fusinvsnmp']['snmpauth'][2]="Usuário";
$LANG['plugin_fusinvsnmp']['snmpauth'][4]="Protocolo de criptografia para autenticação";
$LANG['plugin_fusinvsnmp']['snmpauth'][5]="Senha";
$LANG['plugin_fusinvsnmp']['snmpauth'][6]="Protocolo de criptografia de dados";

$LANG['plugin_fusinvsnmp']['state'][10]="Devices imported";
$LANG['plugin_fusinvsnmp']['state'][4]="Data de início";
$LANG['plugin_fusinvsnmp']['state'][5]="Data final";
$LANG['plugin_fusinvsnmp']['state'][6]="Total de dispositivos de descoberta";
$LANG['plugin_fusinvsnmp']['state'][7]="Total em erro";
...
$LANG['plugin_fusinvsnmp']['title'][1]="Informações SNMP";
$LANG['plugin_fusinvsnmp']['title'][2]="história dos conexões";
$LANG['plugin_fusinvsnmp']['title'][5]="Fechaduras de FusionInventory";
