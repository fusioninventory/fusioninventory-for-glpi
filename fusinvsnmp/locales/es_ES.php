...
$LANG['plugin_fusinvsnmp']['mapping'][423]="impresora > métricas > número total de páginas impresas (impresión)";
$LANG['plugin_fusinvsnmp']['mapping'][424]="impresora > métricas > número de páginas B/N impresas (impresión)";
$LANG['plugin_fusinvsnmp']['mapping'][425]="impresora > métricas > número de páginas color impresas (impresión)";
$LANG['plugin_fusinvsnmp']['mapping'][426]="impresora > métricas > número total de páginas impresas (copia)";
$LANG['plugin_fusinvsnmp']['mapping'][427]="impresora > métricas > número de páginas B/N impresas (copia)";
$LANG['plugin_fusinvsnmp']['mapping'][428]="impresora > métricas > número de páginas color impresas (copia)";
...
$LANG['plugin_fusinvsnmp']['mapping'][99]="impresora > consumibles > equipo de mantenimiento (remaining)";
