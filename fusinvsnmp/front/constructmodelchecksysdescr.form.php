   ...
   if ($pfConstructmodel->showAuth()) {
      if (isset($_POST['sendsnmpwalk'])
         ...
         if (!empty($message)){
            ...
            Html::redirect($CFG_GLPI['root_doc']."/plugins/fusinvsnmp/front/constructmodeldevice.form.php");
         }
      } else {
         $_SESSION['plugin_fusioninventory_snmptool_device']   = array();
