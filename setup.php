...
function plugin_init_tracker() {
	...
	pluginNewType('tracker', "PLUGIN_TRACKER_MAC_UNKNOWN", 5153, "plugin_tracker_unknown", "glpi_plugin_tracker_unknown_device", "front/plugin_tracker.unknown.php", $LANGTRACKER["processes"][13]);
