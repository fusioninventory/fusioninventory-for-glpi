...
function plugin_init_tracker() {
	...
	pluginNewType('tracker', "PLUGIN_TRACKER_MAC_UNKNOW", 5153, "Threads", "glpi_plugin_tracker_processes_values", "front/plugin_tracker.processes.unknow_mac.php", $LANGTRACKER["processes"][13]);
