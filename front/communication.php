...
<REQUEST>
  <CONTENT>
    <ACCESSLOG>
      <LOGDATE>2010-08-14 00:17:19</LOGDATE>
      <USERID>N/A</USERID>
    </ACCESSLOG>
    <BATTERIES>
    ...
    <HARDWARE>
      ...
      <DESCRIPTION>amd64/00-00-00 04:29:57</DESCRIPTION>
      <DNS>212.27.40.240/212.27.40.241</DNS>
      <ETIME>1</ETIME>
      <IPADDR>192.168.1.15/192.168.200.6</IPADDR>
      <MEMORY>2987</MEMORY>
      <NAME>port003</NAME>
    ...
    <PROCESSES>
      <CMD>perl -Ilib -MFusionInventory::Agent::Task::Inventory -e FusionInventory::Agent::Task::Inventory::main(); -- /var/lib/fusioninventory-agent/http:__127.0.0.1_glpi078_p</CMD>
      <CPUUSAGE>13.6</CPUUSAGE>
      <MEM>0.6</MEM>
      <PID>5036</PID>
      <TTY>6</TTY>
      <USER>root</USER>
    ...
    <PROCESSES>
      <CMD>/usr/local/lib/nspluginwrapper/i386/linux/npviewer.bin --plugin /usr/local/lib/linux-mozilla/plugins/libflashplayer.so --connection /org/wrapper/NSPlugins/libflashpl</CMD>
      <CPUUSAGE>5.7</CPUUSAGE>
      <MEM>1.6</MEM>
      <PID>2011</PID>
      <TTY>??</TTY>
      <USER>ddurieux</USER>
      <VIRTUALMEMORY>162176</VIRTUALMEMORY>
    </PROCESSES>
    <PROCESSES>
      <CMD>perl fusioninventory-agent --devlib --debug --server=http://127.0.0.1/glpi078/plugins/fusioninventory/front/communication.php (perl5.10.1)</CMD>
      <CPUUSAGE>3.1</CPUUSAGE>
      <MEM>0.7</MEM>
      <PID>5034</PID>
      <TTY>6</TTY>
      <USER>root</USER>
    ...
    <PROCESSES>
      <CMD>/usr/local/bin/X :0 -auth /home/ddurieux/.serverauth.1198 (Xorg)</CMD>
      <CPUUSAGE>1.4</CPUUSAGE>
      <MEM>10.1</MEM>
      <PID>1217</PID>
      <TTY>v0</TTY>
      <USER>root</USER>
      <VIRTUALMEMORY>423360</VIRTUALMEMORY>
    </PROCESSES>
    <PROCESSES>
      ...
      <TTY>??</TTY>
      <USER>www</USER>
      <VIRTUALMEMORY>200248</VIRTUALMEMORY>
    </PROCESSES>
    <PROCESSES>
      <CMD>[intr]</CMD>
      <CPUUSAGE>0.3</CPUUSAGE>
      <MEM>0.0</MEM>
      <PID>12</PID>
      <TTY>??</TTY>
      <USER>root</USER>
    ...
    <PROCESSES>
      ...
      <TTY>??</TTY>
      <USER>ddurieux</USER>
      <VIRTUALMEMORY>163452</VIRTUALMEMORY>
    </PROCESSES>
    <PROCESSES>
      <CMD>[kernel]</CMD>
    ...
    <PROCESSES>
      ...
      <TTY>??</TTY>
      <USER>root</USER>
      <VIRTUALMEMORY>18924</VIRTUALMEMORY>
    </PROCESSES>
    <PROCESSES>
      <CMD>/usr/local/sbin/httpd</CMD>
      <CPUUSAGE>0.0</CPUUSAGE>
      ...
      <TTY>??</TTY>
      <USER>root</USER>
      <VIRTUALMEMORY>198200</VIRTUALMEMORY>
    </PROCESSES>
    <PROCESSES>
    ...
    <PROCESSES>
      ...
      <TTY>??</TTY>
      <USER>www</USER>
      <VIRTUALMEMORY>201272</VIRTUALMEMORY>
    </PROCESSES>
    <PROCESSES>
      <CMD>/usr/local/sbin/httpd</CMD>
      <CPUUSAGE>0.0</CPUUSAGE>
      ...
      <TTY>??</TTY>
      <USER>www</USER>
      <VIRTUALMEMORY>202296</VIRTUALMEMORY>
    </PROCESSES>
    <PROCESSES>
      <CMD>xbindkeys</CMD>
      <CPUUSAGE>0.0</CPUUSAGE>
    ...
    <PROCESSES>
      ...
      <TTY>??</TTY>
      <USER>ddurieux</USER>
      <VIRTUALMEMORY>42920</VIRTUALMEMORY>
    </PROCESSES>
    <PROCESSES>
    ...
    <PROCESSES>
      ...
      <TTY>??</TTY>
      <USER>ddurieux</USER>
      <VIRTUALMEMORY>402304</VIRTUALMEMORY>
    </PROCESSES>
    <PROCESSES>
      <CMD>[sh]</CMD>
      <CPUUSAGE>0.0</CPUUSAGE>
    ...
    <PROCESSES>
      ...
      <TTY>??</TTY>
      <USER>ddurieux</USER>
      <VIRTUALMEMORY>535076</VIRTUALMEMORY>
    </PROCESSES>
    <PROCESSES>
      <CMD>/usr/local/sbin/httpd</CMD>
      <CPUUSAGE>0.0</CPUUSAGE>
    ...
    <PROCESSES>
      ...
      <TTY>??</TTY>
      <USER>ddurieux</USER>
      <VIRTUALMEMORY>85232</VIRTUALMEMORY>
    </PROCESSES>
    <PROCESSES>
      <CMD>xterm -sb</CMD>
      <CPUUSAGE>0.0</CPUUSAGE>
    ...
    <PROCESSES>
      ...
      <TTY>??</TTY>
      <USER>ddurieux</USER>
      <VIRTUALMEMORY>33248</VIRTUALMEMORY>
    </PROCESSES>
    <PROCESSES>
      <CMD>/usr/local/lib/nspluginwrapper/i386/linux/npviewer.bin --plugin /usr/local/lib/linux-mozilla/plugins/libflashplayer.so --connection /org/wrapper/NSPlugins/libflashpl</CMD>
      <CPUUSAGE>0.0</CPUUSAGE>
    ...
    <PROCESSES>
      <CMD>/bin/sh /usr/local/bin/mysqld_safe --defaults-extra-file=/var/db/mysql/my.cnf --user=mysql --datadir=/var/db/mysql --pid-file=/var/db/mysql/port003.pid</CMD>
      <CPUUSAGE>0.0</CPUUSAGE>
      <MEM>0.1</MEM>
      <PID>932</PID>
      <TTY>v0-</TTY>
    ...
    <PROCESSES>
      <CMD>/usr/local/libexec/mysqld --defaults-extra-file=/var/db/mysql/my.cnf --basedir=/usr/local --datadir=/var/db/mysql --log-error=/var/db/mysql/port003.err --pid-file=/v</CMD>
      <CPUUSAGE>0.0</CPUUSAGE>
      <MEM>1.1</MEM>
      <PID>981</PID>
      <TTY>v0-</TTY>
    ...
    <PROCESSES>
      <CMD>xinit /home/ddurieux/.xinitrc -- /usr/local/bin/X :0 -auth /home/ddurieux/.serverauth.1198</CMD>
      <CPUUSAGE>0.0</CPUUSAGE>
      <MEM>0.1</MEM>
      <PID>1216</PID>
      <TTY>v0</TTY>
    ...
    <PROCESSES>
      ...
      <TTY>v0</TTY>
      <USER>ddurieux</USER>
      <VIRTUALMEMORY>36248</VIRTUALMEMORY>
    </PROCESSES>
    <PROCESSES>
      ...
      <TTY>v0</TTY>
      <USER>ddurieux</USER>
      <VIRTUALMEMORY>41612</VIRTUALMEMORY>
    </PROCESSES>
    <PROCESSES>
    ...
    <PROCESSES>
      <CMD>/bin/sh /usr/local/bin/firefox3</CMD>
      <CPUUSAGE>0.0</CPUUSAGE>
      <MEM>0.1</MEM>
      <PID>1992</PID>
      <TTY>3-</TTY>
    ...
    <PROCESSES>
      <CMD>/bin/sh /usr/local/lib/firefox3/run-mozilla.sh /usr/local/lib/firefox3/firefox-bin</CMD>
      <CPUUSAGE>0.0</CPUUSAGE>
      <MEM>0.1</MEM>
      <PID>1996</PID>
      <TTY>3-</TTY>
    ...
    <PROCESSES>
      <CMD>/usr/local/lib/firefox3/firefox-bin</CMD>
      <CPUUSAGE>0.0</CPUUSAGE>
      <MEM>3.4</MEM>
      <PID>2000</PID>
      <TTY>3-</TTY>
      <USER>ddurieux</USER>
      <VIRTUALMEMORY>256504</VIRTUALMEMORY>
    </PROCESSES>
    <PROCESSES>
      <CMD>csh</CMD>
      <CPUUSAGE>0.0</CPUUSAGE>
    ...
    <SOFTWARES>
      <COMMENTS>Mpeg-4 library and tools from mpeg4ip</COMMENTS>
      <NAME>mpeg4ip-libmp4v2</NAME>
    ...
    <SOFTWARES>
      <COMMENTS>Multimedia streaming server and player for various audio/vi</COMMENTS>
      <NAME>vlc</NAME>
      <VERSION>1.0.6_3,3</VERSION>
    </SOFTWARES>
    <SOFTWARES>
    ...
    <SOFTWARES>
      ...
      <NAME>x264</NAME>
      <VERSION>0.0.20100222_2</VERSION>
    </SOFTWARES>
    <SOFTWARES>
    ...
    <VERSIONCLIENT>FusionInventory-Agent_v2.1_rc3</VERSIONCLIENT>
  </CONTENT>
