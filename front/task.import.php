...
Html::header(__('FusionInventory', 'fusioninventory'), $_SERVER["PHP_SELF"], "admin",
    "pluginfusioninventorymenu", "task");
...
if (isset($_FILES["importfile"])) {
    ...
    include_once GLPI_ROOT.'/plugins/fusioninventory/scripts/import_jobs.php';
} else {
    ...
    echo "<tr>";
    echo "<th>";
    echo __('Import jobs and tasks from a CSV file', 'fusioninventory')." :";
    echo "</th>";
    echo "</tr>";
