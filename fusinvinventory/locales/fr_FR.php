...
$LANG['plugin_fusinvinventory']['antivirus'][1]="Cet ordinateur n'est pas sous Windows XP et plus récent ou n'a pas d'antivirus d'installé";
...
$LANG['plugin_fusinvinventory']['computer'][1]="Propriétaire";
$LANG['plugin_fusinvinventory']['computer'][2]="Entreprise";
...
$LANG['plugin_fusinvinventory']['setup'][17]="Le plugin FusionInventory INVENTORY a besoin que le plugin FusionInventory soit activé pour être lui-même activé.";
$LANG['plugin_fusinvinventory']['setup'][18]="Le plugin FusionInventory INVENTORY a besoin que le plugin FusionInventory soit activé pour être lui-même désinstallé.";
...
$LANG['plugin_fusinvinventory']['setup'][33]="Cette option va fusionner les éléments qui ont le même nom et donc réduire le nombre d'élément si cette gestion n'est pas importante";
$LANG['plugin_fusinvinventory']['setup'][34]="Cette option va créer un élément pour chaque élément trouvé";
$LANG['plugin_fusinvinventory']['setup'][35]="Cette option va créer un élément pour chaque élément qui a un numéro de série";
