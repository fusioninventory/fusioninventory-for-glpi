...
$LANG['plugin_fusinvinventory']['computer'][0]="Viimane laoseis";
...
$LANG['plugin_fusinvinventory']['importxml'][3]="XML-fail pole korrektne!";
...
$LANG['plugin_fusinvinventory']['menu'][1]="Kriteeriumi reeglid";
$LANG['plugin_fusinvinventory']['menu'][2]="Must nimekiri";
$LANG['plugin_fusinvinventory']['menu'][4]="Andmete korrasoleku kontroll";
...
$LANG['plugin_fusinvinventory']['rule'][1]="Olemasolev kriteerium";
$LANG['plugin_fusinvinventory']['rule'][2]="Seerianumber";
$LANG['plugin_fusinvinventory']['rule'][30]="Import in asset";
$LANG['plugin_fusinvinventory']['rule'][31]="Import in unknown devices";
$LANG['plugin_fusinvinventory']['rule'][3]="MAC aadress";
$LANG['plugin_fusinvinventory']['rule'][4]="Microsofti tootevõti";
$LANG['plugin_fusinvinventory']['rule'][5]="Arvuti mudel";
$LANG['plugin_fusinvinventory']['rule'][6]="Kõvaketta seerianumber";
$LANG['plugin_fusinvinventory']['rule'][7]="Partitions serial number";
$LANG['plugin_fusinvinventory']['rule'][8]="Silt";
...
$LANG['plugin_fusinvinventory']['setup'][20]="Importimise valikud";
$LANG['plugin_fusinvinventory']['setup'][21]="Komponendid";
$LANG['plugin_fusinvinventory']['setup'][22]="Üldine import";
$LANG['plugin_fusinvinventory']['setup'][23]="Importi pole";
$LANG['plugin_fusinvinventory']['setup'][24]="Ainulaadne import";
$LANG['plugin_fusinvinventory']['setup'][25]="Register";
...
$LANG['plugin_fusinvinventory']['setup'][36]="Vaikimisi staatus";

$LANG['plugin_fusinvinventory']['title'][0]="FusionInventory INVENTORY";
$LANG['plugin_fusinvinventory']['title'][1]="Kohalik laoseis";
