...
define ("PLUGIN_FUSINVINVENTORY_VERSION","0.83+1.0");
...
//      = 'PluginFusioninventoryInventoryComputerInventory';
   ...
   if (isset($_SESSION["glpiID"])) {
      ...
      $PLUGIN_HOOKS['item_update']['fusinvinventory'] = array('PluginFusioninventoryInventoryComputerAntivirus' => array('PluginFusioninventoryInventoryComputerAntivirus', 'addhistory'));
