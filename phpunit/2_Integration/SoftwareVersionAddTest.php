...
class SoftwareVersionAddTest extends RestoreDatabase_TestCase {
   ...
   public function updateVersionWithOS() {
      ...
      $versions_id = $software->add(['name' => '2.4',
                                      'entities_id' => 0,
      ...
      $operatingsystems_id = Dropdown::importExternal('glpi_operatingsystems', 'Windows');
      $a_computerinventory = array(
         'Computer' => array(
           ...
           'uuid'                             => '493845E00-E5BE-11DF-801C-B05981263302',
           'domains_id'                       => 0,
           'manufacturers_id'                 => 0,
           'computermodels_id'                => 0,
           'serial'                           => '1234',
          ...
          'software'       => array(
             ['name' => 'FusionInventory-Agent',
              'manufacturers_id' => 0,
              'version' => '2.4',
              'comp_key_noos' => 'FusionInventory-Agent$$$$2.4$$$$0$$$$0$$$$0',
              'operatingsystems_id' => $operatingsystems_id,
              'entities_id' => 0
             ]),
          'harddrive'      => array(),
      ...
      $pfiComputerLib->updateComputer($a_computerinventory,
                                      ...
                                      false,
                                      1);
     Toolbox::logDebug(getAllDatasFromTable('glpi_softwareversions', "`name`='2.4'"));
