...
class RepositoryTest extends RestoreDatabase_TestCase {
   ...
   protected function setUp() {
      ...
      $this->assertGreaterThan(0, $this->packages_1_id);

      // create a second package
      $this->packages_2_id = $pfDeployPackage->add([
         'name' => 'test package 2',
      ]);
      $this->assertGreaterThan(0, $this->packages_2_id);
   ...
   protected function teardown() {
      ...
      // remove packages
      if ($pfDeployPackage->getFromDB($this->packages_1_id)) {
         $pfDeployPackage->delete([
            'id' => $this->packages_1_id
         ], true);
      }
      if ($pfDeployPackage->getFromDB($this->packages_2_id)) {
         $pfDeployPackage->delete([
